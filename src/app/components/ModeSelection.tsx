...
export default function ModeSelection({
  ...
  function handleVoiceSelection(text: string) {
    ...
    if (lower.includes("productivity") || lower.includes("productive") || lower.includes("one") || lower.includes("1")) {
      speak("Opening Productivity Mode");
      setStatus("Speaking...");
      setTimeout(() => onSelectMode("productivity"), 2000);
    }

    else if (lower.includes("learn") || lower.includes("two") || lower.includes("2")) {
      speak("Opening Learning Mode");
      setStatus("Speaking...");
      setTimeout(() => onSelectMode("learning"), 2000);
    }

    else if (lower.includes("research") || lower.includes("three") || lower.includes("3")) {
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[24px] font-bold" style={{ fontFamily: 'Neuton, serif' }}>Productivity Mode</span>
            </div>
          </button>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[24px] font-bold" style={{ fontFamily: 'Neuton, serif' }}>Learning Mode</span>
            </div>
          </button>
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[24px] font-bold" style={{ fontFamily: 'Neuton, serif' }}>Research Mode</span>
            </div>
          </button>
